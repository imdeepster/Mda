    ...
    <body>
        <div id="wrapper">
            <div id="header-wrapper">
                <div id="header">
                    <div id="logo">
                        <h1><a href="#">RESOLVE THE CLASSIFICATION PROBLEM OVER ENCRYPTED DATA</h1>				
                    </div>
                    <div id="menu">
                        <ul>
                            <li><a href="serverHome.jsp">Server Home</a></li>
                            <li class="current_page_item"><a href="dataKey.jsp">Data Key</a></li>
                            <li><a href="verifyData.jsp">Verify Data</a></li>
