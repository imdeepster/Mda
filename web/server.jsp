                ...
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            ...
                            <li class="current_page_item"><a href="server.jsp">Server</a></li>
            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        <div id="content">
                            <div class="post">
                                <h4 class="title"><a href="#">RESOLVE THE CLASSIFICATION PROBLEM OVER ENCRYPTED DATA</a></h4>
                                <div class="entry">
                                    <%if (request.getParameter("msg") != null) {
                                                                  out.println(request.getParameter("msg"));
                                                              }%>
                                    <h3>Server Login</h3>
                                    <form name="" action="ServerLogin">
                                        <table width="70%">
